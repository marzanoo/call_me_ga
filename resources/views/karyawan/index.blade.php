...
<div class="container mx-auto p-4">
    <div class="bg-white p-4 rounded-lg shadow-md text-center mb-4">
        ...
        <p class="flex text-sm text-gray-500 mb-6">12 Januari 2026</p>
        <div class="bg-gray-50 p-5 rounded-lg border border-gray-200">
            <div class="flex items-start gap-3">
                <div class="w-6 h-6 bg-yellow-400 rounded-full flex-shrink-0 mt-0.5"></div>
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                        <h4 class="font-semibold text-gray-900">Menunggu Validasi</h4>
                        <span class="text-gray-400">|</span>
                        <span class="text-sm text-gray-500">12 Januari 2026 - 08:10</span>
                    </div>
                    <p class="text-sm text-gray-600 leading-relaxed text-left">
                        Laporan sedang dalam proses pemeriksaan oleh petugas. Mohon menunggu proses validasi.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white p-4 rounded-lg shadow-md text-center mb-4">
        ...
        <p class="flex text-sm text-gray-500 mb-6">Period 1 Jan 2024 - 30 Dec 2024</p>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p class="flex text-2xl font-semibold text-gray-800">12</p>
            </div>
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div class="flex mb-2">
                ...
                <p class="flex text-2xl font-semibold text-gray-800">3</p>
            </div>
        </div>
    </div>
</div>
