...
<div class="container mx-auto p-4">
    ...
    <div class="flex items-center mb-2">
        ...
        <a href="{{ route('admin.reports.finish.index') . '?status=selesai' }}" class="text-lg font-semibold flex items-center w-fit">
        @endif
        @if (session('login_via_superapp'))
        <a href="{{ route('admin.reports.finish.done.index') }}" class="text-lg font-semibold flex items-center w-fit">
        @endif
