...
<div class="container mx-auto p-4">
    ...
    <div class="bg-white p-4 rounded-lg shadow-md mb-4">
        ...
        <a href="{{ route('admin.reports.finish.done.show', ['id' => $report->id]) }}" class="btn block w-full bg-[#B3282D] text-white py-2 px-4 rounded-lg shadow-md text-center">Lihat</a>
    </div>
    @endforeach
</div>
@endsection