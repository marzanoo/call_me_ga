...
<div class="container mx-auto p-4">
    ...
    <h5 class="font-semibold text-gray-800 text-2xl mb-4">Laporan Menunggu</h5>
    ...
    <div class="bg-white p-4 rounded-lg shadow-md mb-4">
        ...
        <a href="{{ route('admin.reports.waiting.show', ['id' => $report->id]) }}" class="btn block w-full bg-[#B3282D] text-white py-2 px-4 rounded-lg shadow-md text-center">Lihat dan Update Status</a>
    </div>
    @endforeach
</div>
@endsection