...
<div class="container mx-auto p-4">
    ...
    <div class="grid gap-4 md:grid-cols-3">
        ...
        <a href="{{ route('admin.master.categories.index') }}" class="bg-white p-5 rounded-lg shadow-md border border-gray-100 hover:border-[#B3282D] transition">
            <p class="text-sm text-gray-500 mb-2">Total: {{ $categoryCount }}</p>
            <h6 class="text-lg font-bold text-gray-800 mb-2">Master Kategori</h6>
            <p class="text-sm text-gray-600">Kelola kategori kerusakan atau kebutuhan fasilitas.</p>
        </a>
